 ...
 */
public class old_order_screen extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (i < cat.length)
        {
            ...
            while (j < dish_num)
            {
                ...
                FrameLayout.LayoutParams dish1_fl_flp = new FrameLayout.LayoutParams(355,155);
                ...
                FrameLayout.LayoutParams dish1_fl2_flp = new FrameLayout.LayoutParams(345,145);
                ...
                order_btn_flp.setMargins(0,35,0,0);
                order_btn_flp.setMarginStart(2);
...
//-----------------------------------------  Create Right Item  ---------------------------------------------//
                if ( j<dish_num) {
                    ...
                    dish2_fl0.setBackgroundColor(0xFFffffff);

                    FrameLayout dish2_fl = new FrameLayout(this);
                    FrameLayout.LayoutParams dish2_fl_flp = new FrameLayout.LayoutParams(355, 155);
                    ...
                    FrameLayout.LayoutParams dish2_fl2_flp = new FrameLayout.LayoutParams(345, 145);
                    ...
                    dish2_order_btn_flp.setMarginStart(2);
